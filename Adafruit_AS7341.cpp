 ...
 */
bool Adafruit_AS7341::begin_I2C(uint8_t i2c_address, TwoWire *wire,
                                int32_t sensor_id) {
  spi_dev = NULL;
  if (i2c_dev) {
 ...
 *    @return True if initialization was successful, otherwise false.
 */
bool Adafruit_AS7341::begin_SPI(uint8_t cs_pin, SPIClass *theSPI,
                                int32_t sensor_id) {
  i2c_dev = NULL;
 ...
 *    @return True if initialization was successful, otherwise false.
 */
bool Adafruit_AS7341::begin_SPI(int8_t cs_pin, int8_t sck_pin, int8_t miso_pin,
